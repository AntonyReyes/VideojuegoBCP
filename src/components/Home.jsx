...
const Home = () => {
  ...
  return (
    <div className='home'>
      ...
      <p class="p_home">El juego FINANZAS PARA EMPRENDEDORES nos ayudarà a usar los diferentes conceptos de 
        la educaciòn financiera; el futuro económico, y no económico, de una persona lo determina más la buena o mala gestión del dinero que haga esa persona que los ingresos que llegue a tener a lo largo de su vida.
      </p>
